    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('flask_api_key') ? 'is-invalid' : '' }}" type="text" name="flask_api_key" id="flask_api_key" value="{{ old('flask_api_key', $setting->flask_api_key) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('last_sync') ? 'is-invalid' : '' }}" type="text" name="last_sync" id="last_sync" value="{{ old('last_sync', $setting->last_sync) }}">
