...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.predictHistory.title_singular') }} {{ trans('global.list') }}
        </div>

        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-PredictHistory">
                <thead>
                <tr>
                    <th width="10">
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            @can('predict_history_delete')
            let deleteButtonTrans = '{{ trans('global.datatables.delete') }}';
            let deleteButton = {
                text: deleteButtonTrans,
                url: "{{ route('admin.predict-histories.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.predict-histories.index') }}",
                columns: [
            ...
            let table = $('.datatable-PredictHistory').DataTable(dtOverrideGlobals);
